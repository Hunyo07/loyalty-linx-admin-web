      ...
      <div class="hidden w-full xl:block xl:w-1/2">
        <div class="py-17.5 px-26 text-center">
          <router-link class="mb-5.5 inline-block" to="/">
            <img class="hidden dark:block" src="@/assets/images/loyaltilinxicon.png" alt="Logo" />
            <img class="dark:hidden" src="@/assets/images/loyaltilinxicon.png" alt="Logo" />
          </router-link>

          <p class="font-medium 2xl:px-20">Seamless Rewards, Simple Credit, and Endless Benefits</p>
